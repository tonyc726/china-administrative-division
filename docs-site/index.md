...
features:
  - icon: 🧊
    title: 2023 全量基线快照
    details: 国家统计局 stats.gov.cn 自 2024 年停更、2026 转向国家地名信息库。v2 以 2023 五级全量为不可变基线，村级 620,573 条冻结留档。
    link: /data/snapshots
    linkText: 下载历年快照
  - icon: 🧩
    title: 社区 Patch 增量
  ...
  - icon: 📦
    title: 用户侧零爬虫
    details: cndiv hydrate 从 NPM 拉取数据包注水到本地 SQLite（~/.cndiv/cache.db），标准 SQLite 可直接 SQL 查询，大数据不进 git。
    link: /guide/getting-started
    linkText: CLI 注水
  - icon: 🔢
    title: 纯函数码工具
